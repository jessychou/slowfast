...
class VideoVisualizer:
    def __init__(
        ...
        print(f'class_names_path is {class_names_path}')
        self.class_names, _, _ = get_class_names(class_names_path, None, None)
        self.top_k = top_k
        self.thres = thres
        self.lower_thres = lower_thres
        print(f"class_names are {self.class_names}")
        print(f"len(class_names) is {len(self.class_names)}")
        print(f"common_class_names are f{common_class_names}")
    ...
    def _get_thres_array(self, common_class_names=None):
        ...
        print(f"num_classes in _get_thres_array is {self.num_classes}")
        print(f"common class ids in _get_thres_array is {common_class_ids}")
