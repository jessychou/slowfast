...
class VideoManager:
    ...
    def __init__(self, cfg):
        ...
        print(f"cfg.DEMO.INPUT_VIDEO is {cfg.DEMO.INPUT_VIDEO}")
    ...
    def display(self, task):
        ...
        """
        print("display task", task.id, task.action_preds.shape)
        print("display task frames", len(task.frames))
...
class ThreadVideoManager:
    ...
    def display(self, task):
        ...
        """
        with self.write_lock:
            print("display task", task.id, task)
